...
// TODO use Bernhard's suggestion to update ghost state at linearization points
// without putting it in the same atomic procedure as write/read
...
{
  var {:linear "this"} this: Invoc; var old_tabvis: [int]SetInvoc;
